...
exports.up = async (pgm) => {
  ...
  pgm.addColumn('pedidos', { status_new: { type: 'pedido_status_v2', notNull: true, default: 'confirmado' } });
...
exports.down = async (pgm) => {
  ...
  pgm.addColumn('pedidos', { status_old: { type: 'pedido_status_old', notNull: true, default: 'confirmado' } });

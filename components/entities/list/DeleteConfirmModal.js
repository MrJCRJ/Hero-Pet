...
export function DeleteConfirmModal({ open, onClose, onConfirm, loading, entity }) {
  if (!open) return null;
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center">
      ...
      >
        ...
        <div className="flex justify-end gap-2 pt-1">
          <Button size="sm" variant="outline" type="button" disabled={loading} onClick={onClose}>
            Cancelar
          </Button>
          <Button size="sm" variant="secondary" type="button" loading={loading} disabled={loading} onClick={onConfirm}>

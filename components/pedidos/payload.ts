...
interface BuildPedidoPayloadBaseParams {
  ...
  parcelado?: boolean;
  numeroPromissorias?: number | string;
  dataPrimeiraPromissoria?: string | null;
  promissoriaDatas?: string[];
  itens: Array<Record<string, unknown>>;
  freteTotal?: number | string | null;
  tipo?: string;
}
...
export function buildPedidoPayloadBase({
  ...
  freteTotal,
  tipo,
}: BuildPedidoPayloadBaseParams): Record<string, unknown> {
  return {

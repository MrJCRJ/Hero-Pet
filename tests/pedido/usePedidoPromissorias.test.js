...
describe('usePedidoPromissorias', () => {
  ...
  test('gera mensal corretamente', async () => {
    ...
    await advanceEffects();
    expect(result.current.promissoriaDatas).toEqual(['2025-01-10', '2025-02-10', '2025-03-10']);
  });
  ...
  test('gera quinzenal corretamente', async () => {
    ...
    await advanceEffects();
    expect(result.current.promissoriaDatas).toEqual(['2025-01-01', '2025-01-16', '2025-01-31']);
  });
  ...
  test('gera semanal corretamente', async () => {
    ...
    await advanceEffects();
    expect(result.current.promissoriaDatas).toEqual(['2025-03-05', '2025-03-12', '2025-03-19', '2025-03-26']);
  });
  ...
  test('gera por dias customizados', async () => {
    ...
    await advanceEffects();
    expect(result.current.promissoriaDatas).toEqual(['2025-04-10', '2025-04-20', '2025-04-30']);
  });

...
beforeAll(async () => {
  ...
  if (![200, 201].includes(mig.status)) throw new Error("Falha migração summary");

  const registros = [
    { name: "P1", entity_type: "PF", document_digits: "", document_pending: true },
    { name: "P2", entity_type: "PF", document_digits: "39053344705", document_pending: false },
    { name: "P3", entity_type: "PF", document_digits: "12345", document_pending: false },
  ];
